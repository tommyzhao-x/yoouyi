                        ...
                        <div class="col-md-4 ly-line">
                            <div class="thumbnail" href="../examples/dashboard/">
                                ...
                                <div class="row ly-line-title">
                                    <div class="col-md-12">双人家！有效期到12月23日。厦门时代广场九点4天3夜游！</div>
                                </div>
                                <div class="ly-dashed"></div>
                                <div class="row ly-line-info">
                                    <div class="col-md-6 text-left ly-line-price">￥980元</div>
                                    <div class="col-md-6 text-right ly-line-platform">土牛网</div>
                                </div>
                                <div class="row ly-line-info">
